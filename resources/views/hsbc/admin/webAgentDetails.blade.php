                ...
                <div class="py-12">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" >
                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <p class="fs-5 mb-2 "><b>Supervisor:</b><a href="{{route('admin.supervisorDetails', [$supervisor])}}"> {{$supervisor->name}}</a></p>
                            <p class="fs-5 mb-2 "><b>Team:</b> {{$user->team()->first()->name}}</p>
                            <p></p>
                            ...
                            @endif
                            <a  class="fs-5 mt-2 pt-3" href="{{route('admin.showWebAgents')}}"> < Back </a>
                        </div>
                    </div>
                </div>
            </div>
